...
<html>
<head>
    <title> Jananapriya - Portfolio</title>
    <style>
        body {
...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="Jananapriya.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Jananapriya</h1>
            <p> i am in student</p>
        </div>
    </header>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p> hellow everyone this is Jananapriya and i am  computer science student my ambition police officer  </p>
        </div>
    </section>
